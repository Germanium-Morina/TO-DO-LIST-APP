      ...
      <div className='flex flex-col bg-white rounded-lg xl:w-2/5 lg:w-2/4 md:w-3/5 sm:w-3/4 mobile:w-4/5 w-full shadow-gray-200 shadow-lg ml-3 mr-3 mb-6'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-10 md:pl-6 md:pr-6 pl-2 pr-2'>
          <div className='flex flex-col gap-3'>
            <div className='flex flex-col w-full gap-1'>
              ...
              <div className='flex flex-col'>
                ...
                />
                {isSubmitted && errors.fullName && <span className='pl-1 text-sm text-red-600'>{errors.fullName}</span>}</div>
          ...
          <div className='flex flex-row justify-between items-center mb-3 gap-4'>
            <Link to="/" className='text-sm text-blue-700'>Already have an account?</Link>
            <button type="submit" className='text-base bg-blue-600 text-white pl-3 pr-3 pt-2 pb-2 rounded-lg whitespace-nowrap'>Sign Up</button>
          </div>
        </form>
      </div>
