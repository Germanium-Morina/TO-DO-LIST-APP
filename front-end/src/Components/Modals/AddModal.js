    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div ref={modalRef} className="bg-white rounded-lg w-full max-w-lg m-3">
        ...
        <div className="flex justify-between border-t-4 sm:pl-4 sm:pr-4 pl-2 pr-2 py-4 mt-3">
          <button onClick={handleSubmitClick} className="bg-blue-600 text-white px-4 py-2 rounded-lg shadow-blue-200 shadow-md hover:shadow-blue-300 hover:shadow-md hover:bg-blue-800">Add Task</button>
